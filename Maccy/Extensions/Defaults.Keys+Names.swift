...
extension Defaults.Keys {
  ...
  static let smsCodeWebhookURL = Key<String>("smsCodeWebhookURL", default: "")
  static let syncClipboardCloudEnabled = Key<Bool>("syncClipboardCloudEnabled", default: false)
  static let syncClipboardCloudURL = Key<String>("syncClipboardCloudURL", default: "")
  static let syncClipboardCloudUsername = Key<String>("syncClipboardCloudUsername", default: "")
  static let syncClipboardCloudPassword = Key<String>("syncClipboardCloudPassword", default: "")
